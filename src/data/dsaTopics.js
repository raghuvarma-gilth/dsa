    ...
    subtopics: [
      {
        ...
        children: [
          ...
          { name: 'Two Sum Ii Input Array Is Sorted', leetcodeLink: 'https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/' },
          { name: '3sum', leetcodeLink: 'https://leetcode.com/problems/3sum/' },
          { name: '4sum', leetcodeLink: 'https://leetcode.com/problems/4sum/' },
          { name: 'Number Of Subsequences That Satisfy The Given Sum Condition', leetcodeLink: 'https://leetcode.com/problems/number-of-subsequences-that-satisfy-the-given-sum-condition/' },
          { name: 'Two Sum Iv Input Is A Bst', leetcodeLink: 'https://leetcode.com/problems/two-sum-iv-input-is-a-bst/' },
          { name: 'Sum Of Square Numbers', leetcodeLink: 'https://leetcode.com/problems/sum-of-square-numbers/' },
          { name: 'Boats To Save People', leetcodeLink: 'https://leetcode.com/problems/boats-to-save-people/' },
          { name: 'Minimize Maximum Pair Sum In Array', leetcodeLink: 'https://leetcode.com/problems/minimize-maximum-pair-sum-in-array/' },
          { name: '3sum With Multiplicity', leetcodeLink: 'https://leetcode.com/problems/3sum-with-multiplicity/' },
          { name: 'Trapping Rain Water', leetcodeLink: 'https://leetcode.com/problems/trapping-rain-water/' },
          { name: 'Container With Most Water', leetcodeLink: 'https://leetcode.com/problems/container-with-most-water/' },
          { name: 'Next Permutation', leetcodeLink: 'https://leetcode.com/problems/next-permutation/' },
          { name: 'Next Greater Element Iii', leetcodeLink: 'https://leetcode.com/problems/next-greater-element-iii/' },
          { name: 'Minimum Adjacent Swaps To Reach The Kth Smallest Number', leetcodeLink: 'https://leetcode.com/problems/minimum-adjacent-swaps-to-reach-the-kth-smallest-number/' },
          { name: 'Valid Palindrome', leetcodeLink: 'https://leetcode.com/problems/valid-palindrome/' },
          { name: 'Reverse String', leetcodeLink: 'https://leetcode.com/problems/reverse-string/' },
          { name: 'Reverse Vowels Of A String', leetcodeLink: 'https://leetcode.com/problems/reverse-vowels-of-a-string/' },
          { name: 'Valid Palindrome Ii', leetcodeLink: 'https://leetcode.com/problems/valid-palindrome-ii/' },
          { name: 'Reverse Only Letters', leetcodeLink: 'https://leetcode.com/problems/reverse-only-letters/' },
          { name: 'Remove Element', leetcodeLink: 'https://leetcode.com/problems/remove-element/' },
          { name: 'Sort Colors', leetcodeLink: 'https://leetcode.com/problems/sort-colors/' },
          { name: 'Flipping An Image', leetcodeLink: 'https://leetcode.com/problems/flipping-an-image/' },
          { name: 'Squares Of A Sorted Array', leetcodeLink: 'https://leetcode.com/problems/squares-of-a-sorted-array/' },
          { name: 'Sort Array By Parity', leetcodeLink: 'https://leetcode.com/problems/sort-array-by-parity/' },
          { name: 'Sort Array By Parity Ii', leetcodeLink: 'https://leetcode.com/problems/sort-array-by-parity-ii/' },
          { name: 'Pancake Sorting', leetcodeLink: 'https://leetcode.com/problems/pancake-sorting/' },
          { name: 'Reverse Prefix Of Word', leetcodeLink: 'https://leetcode.com/problems/reverse-prefix-of-word/' },
          { name: 'Reverse String Ii', leetcodeLink: 'https://leetcode.com/problems/reverse-string-ii/' },
          { name: 'Reverse Words In A String', leetcodeLink: 'https://leetcode.com/problems/reverse-words-in-a-string/' },
          { name: 'Reverse Words In A String Iii', leetcodeLink: 'https://leetcode.com/problems/reverse-words-in-a-string-iii/' },
          { name: 'Bag Of Tokens', leetcodeLink: 'https://leetcode.com/problems/bag-of-tokens/' },
          { name: 'Di String Match', leetcodeLink: 'https://leetcode.com/problems/di-string-match/' },
          { name: 'Minimum Length Of String After Deleting Similar Ends', leetcodeLink: 'https://leetcode.com/problems/minimum-length-of-string-after-deleting-similar-ends/' },
          { name: 'Sentence Similarity Iii', leetcodeLink: 'https://leetcode.com/problems/sentence-similarity-iii/' },
          { name: 'Find K Closest Elements', leetcodeLink: 'https://leetcode.com/problems/find-k-closest-elements/' },
          { name: 'Shortest Distance To A Character', leetcodeLink: 'https://leetcode.com/problems/shortest-distance-to-a-character/' },
          { name: 'Linked List Cycle', leetcodeLink: 'https://leetcode.com/problems/linked-list-cycle/' },
          { name: 'Linked List Cycle Ii', leetcodeLink: 'https://leetcode.com/problems/linked-list-cycle-ii/' },
          { name: 'Remove Nth Node From End Of List', leetcodeLink: 'https://leetcode.com/problems/remove-nth-node-from-end-of-list/' },
          { name: 'Rotate List', leetcodeLink: 'https://leetcode.com/problems/rotate-list/' },
          { name: 'Reorder List', leetcodeLink: 'https://leetcode.com/problems/reorder-list/' },
          { name: 'Palindrome Linked List', leetcodeLink: 'https://leetcode.com/problems/palindrome-linked-list/' },
          { name: 'Find The Duplicate Number', leetcodeLink: 'https://leetcode.com/problems/find-the-duplicate-number/' },
          { name: 'Circular Array Loop', leetcodeLink: 'https://leetcode.com/problems/circular-array-loop/' },
          { name: 'Number Of Subarrays With Bounded Maximum', leetcodeLink: 'https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum/' },
          { name: 'Find K Th Smallest Pair Distance', leetcodeLink: 'https://leetcode.com/problems/find-k-th-smallest-pair-distance/' },
          { name: 'Moving Stones Until Consecutive Ii', leetcodeLink: 'https://leetcode.com/problems/moving-stones-until-consecutive-ii/' },
          { name: 'Count Pairs Of Nodes', leetcodeLink: 'https://leetcode.com/problems/count-pairs-of-nodes/' },
          { name: 'Count Binary Substrings', leetcodeLink: 'https://leetcode.com/problems/count-binary-substrings/' },
          { name: 'K Diff Pairs In An Array', leetcodeLink: 'https://leetcode.com/problems/k-diff-pairs-in-an-array/' },
          { name: 'Rotating The Box', leetcodeLink: 'https://leetcode.com/problems/rotating-the-box/' },
          { name: 'Rotate Array', leetcodeLink: 'https://leetcode.com/problems/rotate-array/' },
          { name: 'String Compression', leetcodeLink: 'https://leetcode.com/problems/string-compression/' },
          { name: 'Last Substring In Lexicographical Order', leetcodeLink: 'https://leetcode.com/problems/last-substring-in-lexicographical-order/' },
          { name: 'Remove Duplicates From Sorted Array', leetcodeLink: 'https://leetcode.com/problems/remove-duplicates-from-sorted-array/' },
          { name: 'Remove Duplicates From Sorted Array Ii', leetcodeLink: 'https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/' },
          { name: 'Remove Duplicates From Sorted List Ii', leetcodeLink: 'https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/' },
          { name: 'Duplicate Zeros', leetcodeLink: 'https://leetcode.com/problems/duplicate-zeros/' },
          { name: 'Statistics From A Large Sample', leetcodeLink: 'https://leetcode.com/problems/statistics-from-a-large-sample/' },
          { name: 'Partition Labels', leetcodeLink: 'https://leetcode.com/problems/partition-labels/' },
          { name: 'Magical String', leetcodeLink: 'https://leetcode.com/problems/magical-string/' },
          { name: 'Friends Of Appropriate Ages', leetcodeLink: 'https://leetcode.com/problems/friends-of-appropriate-ages/' },
          { name: 'Longest Mountain In Array', leetcodeLink: 'https://leetcode.com/problems/longest-mountain-in-array/' },
          { name: 'Shortest Subarray To Be Removed To Make Array Sorted', leetcodeLink: 'https://leetcode.com/problems/shortest-subarray-to-be-removed-to-make-array-sorted/' },
          { name: 'Merge Sorted Array', leetcodeLink: 'https://leetcode.com/problems/merge-sorted-array/' },
          { name: 'Heaters', leetcodeLink: 'https://leetcode.com/problems/heaters/' },
          { name: 'Find The Distance Value Between Two Arrays', leetcodeLink: 'https://leetcode.com/problems/find-the-distance-value-between-two-arrays/' },
          { name: 'Intersection Of Two Linked Lists', leetcodeLink: 'https://leetcode.com/problems/intersection-of-two-linked-lists/' },
          { name: 'Intersection Of Two Arrays', leetcodeLink: 'https://leetcode.com/problems/intersection-of-two-arrays/' },
          { name: 'Intersection Of Two Arrays Ii', leetcodeLink: 'https://leetcode.com/problems/intersection-of-two-arrays-ii/' },
          { name: 'Implement Strstr', leetcodeLink: 'https://leetcode.com/problems/implement-strstr/' },
          { name: 'Longest Word In Dictionary Through Deleting', leetcodeLink: 'https://leetcode.com/problems/longest-word-in-dictionary-through-deleting/' },
          { name: 'Long Pressed Name', leetcodeLink: 'https://leetcode.com/problems/long-pressed-name/' },
          { name: 'Longest Uncommon Subsequence Ii', leetcodeLink: 'https://leetcode.com/problems/longest-uncommon-subsequence-ii/' },
          { name: 'Compare Version Numbers', leetcodeLink: 'https://leetcode.com/problems/compare-version-numbers/' },
          { name: 'Camelcase Matching', leetcodeLink: 'https://leetcode.com/problems/camelcase-matching/' },
          { name: 'Expressive Words', leetcodeLink: 'https://leetcode.com/problems/expressive-words/' },
          { name: 'Find Median From Data Stream', leetcodeLink: 'https://leetcode.com/problems/find-median-from-data-stream/' },
          { name: 'Partition Array Into Two Arrays To Minimize Sum Difference', leetcodeLink: 'https://leetcode.com/problems/partition-array-into-two-arrays-to-minimize-sum-difference/' },
          { name: 'Closest Subsequence Sum', leetcodeLink: 'https://leetcode.com/problems/closest-subsequence-sum/' },
          { name: 'Ways To Split Array Into Three Subarrays', leetcodeLink: 'https://leetcode.com/problems/ways-to-split-array-into-three-subarrays/' },
          { name: '3sum Closest', leetcodeLink: 'https://leetcode.com/problems/3sum-closest/' },
          { name: 'Valid Triangle Number', leetcodeLink: 'https://leetcode.com/problems/valid-triangle-number/' },
          { name: 'Shortest Unsorted Continuous Subarray', leetcodeLink: 'https://leetcode.com/problems/shortest-unsorted-continuous-subarray/' },
          { name: 'Most Profit Assigning Work', leetcodeLink: 'https://leetcode.com/problems/most-profit-assigning-work/' },
          { name: 'Largest Merge Of Two Strings', leetcodeLink: 'https://leetcode.com/problems/largest-merge-of-two-strings/' },
          { name: 'Swap Adjacent In Lr String', leetcodeLink: 'https://leetcode.com/problems/swap-adjacent-in-lr-string/' },
          { name: 'Partition List', leetcodeLink: 'https://leetcode.com/problems/partition-list/' },
          { name: 'Sort List', leetcodeLink: 'https://leetcode.com/problems/sort-list/' }
        ]
      },
      {
