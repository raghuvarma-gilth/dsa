    ...
    subtopics: [
      {
        ...
        children: [
          ...
          { name: 'Two Sum Ii Input Array Is Sorted', leetcodeLink: 'https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/', gfgLink: 'https://www.geeksforgeeks.org/problems/two-sum-in-sorted-array/1' },
          { name: '3sum', leetcodeLink: 'https://leetcode.com/problems/3sum/', gfgLink: 'https://www.geeksforgeeks.org/problems/find-all-triplets-with-zero-sum/1' },
          { name: '4sum', leetcodeLink: 'https://leetcode.com/problems/4sum/', gfgLink: 'https://www.geeksforgeeks.org/problems/find-all-four-sum-numbers1732/1' },
          { name: 'Number Of Subsequences That Satisfy The Given Sum Condition', leetcodeLink: 'https://leetcode.com/problems/number-of-subsequences-that-satisfy-the-given-sum-condition/', gfgLink: 'https://www.geeksforgeeks.org/problems/number-of-subsequences-that-satisfy-the-given-sum-condition/1' },
          { name: 'Two Sum Iv Input Is A Bst', leetcodeLink: 'https://leetcode.com/problems/two-sum-iv-input-is-a-bst/', gfgLink: 'https://www.geeksforgeeks.org/problems/find-a-pair-with-given-target-in-bst/1' },
          { name: 'Sum Of Square Numbers', leetcodeLink: 'https://leetcode.com/problems/sum-of-square-numbers/', gfgLink: 'https://www.geeksforgeeks.org/problems/get-minimum-squares0538/1' },
          { name: 'Boats To Save People', leetcodeLink: 'https://leetcode.com/problems/boats-to-save-people/', gfgLink: 'https://www.geeksforgeeks.org/problems/boats-to-save-people/1' },
          { name: 'Minimize Maximum Pair Sum In Array', leetcodeLink: 'https://leetcode.com/problems/minimize-maximum-pair-sum-in-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/minimize-maximum-pair-sum-in-array/1' },
          { name: '3sum With Multiplicity', leetcodeLink: 'https://leetcode.com/problems/3sum-with-multiplicity/', gfgLink: 'https://www.geeksforgeeks.org/problems/3sum-with-multiplicity/1' },
          { name: 'Trapping Rain Water', leetcodeLink: 'https://leetcode.com/problems/trapping-rain-water/', gfgLink: 'https://www.geeksforgeeks.org/problems/trapping-rain-water-1587115621/1' },
          { name: 'Container With Most Water', leetcodeLink: 'https://leetcode.com/problems/container-with-most-water/', gfgLink: 'https://www.geeksforgeeks.org/problems/container-with-most-water/1' },
          { name: 'Next Permutation', leetcodeLink: 'https://leetcode.com/problems/next-permutation/', gfgLink: 'https://www.geeksforgeeks.org/problems/next-permutation/1' },
          { name: 'Next Greater Element Iii', leetcodeLink: 'https://leetcode.com/problems/next-greater-element-iii/', gfgLink: 'https://www.geeksforgeeks.org/problems/next-greater-element-iii/1' },
          { name: 'Minimum Adjacent Swaps To Reach The Kth Smallest Number', leetcodeLink: 'https://leetcode.com/problems/minimum-adjacent-swaps-to-reach-the-kth-smallest-number/', gfgLink: 'https://www.geeksforgeeks.org/problems/minimum-adjacent-swaps-to-reach-the-kth-smallest-number/1' },
          { name: 'Valid Palindrome', leetcodeLink: 'https://leetcode.com/problems/valid-palindrome/', gfgLink: 'https://www.geeksforgeeks.org/problems/valid-palindrome/1' },
          { name: 'Reverse String', leetcodeLink: 'https://leetcode.com/problems/reverse-string/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-string/1' },
          { name: 'Reverse Vowels Of A String', leetcodeLink: 'https://leetcode.com/problems/reverse-vowels-of-a-string/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-vowels-of-a-string/1' },
          { name: 'Valid Palindrome Ii', leetcodeLink: 'https://leetcode.com/problems/valid-palindrome-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/valid-palindrome-ii/1' },
          { name: 'Reverse Only Letters', leetcodeLink: 'https://leetcode.com/problems/reverse-only-letters/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-only-letters/1' },
          { name: 'Remove Element', leetcodeLink: 'https://leetcode.com/problems/remove-element/', gfgLink: 'https://www.geeksforgeeks.org/problems/remove-element/1' },
          { name: 'Sort Colors', leetcodeLink: 'https://leetcode.com/problems/sort-colors/', gfgLink: 'https://www.geeksforgeeks.org/problems/sort-an-array-of-0s-1s-and-2s/1' },
          { name: 'Flipping An Image', leetcodeLink: 'https://leetcode.com/problems/flipping-an-image/', gfgLink: 'https://www.geeksforgeeks.org/problems/flipping-an-image/1' },
          { name: 'Squares Of A Sorted Array', leetcodeLink: 'https://leetcode.com/problems/squares-of-a-sorted-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/squares-of-a-sorted-array/1' },
          { name: 'Sort Array By Parity', leetcodeLink: 'https://leetcode.com/problems/sort-array-by-parity/', gfgLink: 'https://www.geeksforgeeks.org/problems/sort-array-by-parity/1' },
          { name: 'Sort Array By Parity Ii', leetcodeLink: 'https://leetcode.com/problems/sort-array-by-parity-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/sort-array-by-parity-ii/1' },
          { name: 'Pancake Sorting', leetcodeLink: 'https://leetcode.com/problems/pancake-sorting/', gfgLink: 'https://www.geeksforgeeks.org/problems/pancake-sorting/1' },
          { name: 'Reverse Prefix Of Word', leetcodeLink: 'https://leetcode.com/problems/reverse-prefix-of-word/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-prefix-of-word/1' },
          { name: 'Reverse String Ii', leetcodeLink: 'https://leetcode.com/problems/reverse-string-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-string-ii/1' },
          { name: 'Reverse Words In A String', leetcodeLink: 'https://leetcode.com/problems/reverse-words-in-a-string/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-words-in-a-given-string5459/1' },
          { name: 'Reverse Words In A String Iii', leetcodeLink: 'https://leetcode.com/problems/reverse-words-in-a-string-iii/', gfgLink: 'https://www.geeksforgeeks.org/problems/reverse-each-word-in-a-given-string/1' },
          { name: 'Bag Of Tokens', leetcodeLink: 'https://leetcode.com/problems/bag-of-tokens/', gfgLink: 'https://www.geeksforgeeks.org/problems/bag-of-tokens/1' },
          { name: 'Di String Match', leetcodeLink: 'https://leetcode.com/problems/di-string-match/', gfgLink: 'https://www.geeksforgeeks.org/problems/di-string-match/1' },
          { name: 'Minimum Length Of String After Deleting Similar Ends', leetcodeLink: 'https://leetcode.com/problems/minimum-length-of-string-after-deleting-similar-ends/', gfgLink: 'https://www.geeksforgeeks.org/problems/minimum-length-of-string-after-deleting-similar-ends/1' },
          { name: 'Sentence Similarity Iii', leetcodeLink: 'https://leetcode.com/problems/sentence-similarity-iii/', gfgLink: 'https://www.geeksforgeeks.org/problems/sentence-similarity-iii/1' },
          { name: 'Find K Closest Elements', leetcodeLink: 'https://leetcode.com/problems/find-k-closest-elements/', gfgLink: 'https://www.geeksforgeeks.org/problems/k-closest-elements3619/1' },
          { name: 'Shortest Distance To A Character', leetcodeLink: 'https://leetcode.com/problems/shortest-distance-to-a-character/', gfgLink: 'https://www.geeksforgeeks.org/problems/shortest-distance-to-a-character/1' },
          { name: 'Linked List Cycle', leetcodeLink: 'https://leetcode.com/problems/linked-list-cycle/', gfgLink: 'https://www.geeksforgeeks.org/problems/detect-loop-in-linked-list/1' },
          { name: 'Linked List Cycle Ii', leetcodeLink: 'https://leetcode.com/problems/linked-list-cycle-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/remove-loop-in-linked-list/1' },
          { name: 'Remove Nth Node From End Of List', leetcodeLink: 'https://leetcode.com/problems/remove-nth-node-from-end-of-list/', gfgLink: 'https://www.geeksforgeeks.org/problems/nth-node-from-end-of-linked-list/1' },
          { name: 'Rotate List', leetcodeLink: 'https://leetcode.com/problems/rotate-list/', gfgLink: 'https://www.geeksforgeeks.org/problems/rotate-a-linked-list/1' },
          { name: 'Reorder List', leetcodeLink: 'https://leetcode.com/problems/reorder-list/', gfgLink: 'https://www.geeksforgeeks.org/problems/reorder-list/1' },
          { name: 'Palindrome Linked List', leetcodeLink: 'https://leetcode.com/problems/palindrome-linked-list/', gfgLink: 'https://www.geeksforgeeks.org/problems/check-if-linked-list-is-pallindrome/1' },
          { name: 'Find The Duplicate Number', leetcodeLink: 'https://leetcode.com/problems/find-the-duplicate-number/', gfgLink: 'https://www.geeksforgeeks.org/problems/find-duplicates-in-an-array/1' },
          { name: 'Circular Array Loop', leetcodeLink: 'https://leetcode.com/problems/circular-array-loop/', gfgLink: 'https://www.geeksforgeeks.org/problems/circular-array-loop/1' },
          { name: 'Number Of Subarrays With Bounded Maximum', leetcodeLink: 'https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum/', gfgLink: 'https://www.geeksforgeeks.org/problems/number-of-subarrays-with-bounded-maximum/1' },
          { name: 'Find K Th Smallest Pair Distance', leetcodeLink: 'https://leetcode.com/problems/find-k-th-smallest-pair-distance/', gfgLink: 'https://www.geeksforgeeks.org/problems/k-th-smallest-absolute-difference-of-two-elements-in-an-array/1' },
          { name: 'Moving Stones Until Consecutive Ii', leetcodeLink: 'https://leetcode.com/problems/moving-stones-until-consecutive-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/moving-stones-until-consecutive-ii/1' },
          { name: 'Count Pairs Of Nodes', leetcodeLink: 'https://leetcode.com/problems/count-pairs-of-nodes/', gfgLink: 'https://www.geeksforgeeks.org/problems/count-pairs-of-nodes/1' },
          { name: 'Count Binary Substrings', leetcodeLink: 'https://leetcode.com/problems/count-binary-substrings/', gfgLink: 'https://www.geeksforgeeks.org/problems/count-binary-substrings/1' },
          { name: 'K Diff Pairs In An Array', leetcodeLink: 'https://leetcode.com/problems/k-diff-pairs-in-an-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/count-distinct-pairs-with-difference-k/1' },
          { name: 'Rotating The Box', leetcodeLink: 'https://leetcode.com/problems/rotating-the-box/', gfgLink: 'https://www.geeksforgeeks.org/problems/rotating-the-box/1' },
          { name: 'Rotate Array', leetcodeLink: 'https://leetcode.com/problems/rotate-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/rotate-array-by-n-elements/1' },
          { name: 'String Compression', leetcodeLink: 'https://leetcode.com/problems/string-compression/', gfgLink: 'https://www.geeksforgeeks.org/problems/string-compression/1' },
          { name: 'Last Substring In Lexicographical Order', leetcodeLink: 'https://leetcode.com/problems/last-substring-in-lexicographical-order/', gfgLink: 'https://www.geeksforgeeks.org/problems/last-substring-in-lexicographical-order/1' },
          { name: 'Remove Duplicates From Sorted Array', leetcodeLink: 'https://leetcode.com/problems/remove-duplicates-from-sorted-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/remove-duplicate-elements-from-sorted-array/1' },
          { name: 'Remove Duplicates From Sorted Array Ii', leetcodeLink: 'https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/remove-duplicates-from-sorted-array-ii/1' },
          { name: 'Remove Duplicates From Sorted List Ii', leetcodeLink: 'https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/remove-duplicates-from-sorted-list-ii/1' },
          { name: 'Duplicate Zeros', leetcodeLink: 'https://leetcode.com/problems/duplicate-zeros/', gfgLink: 'https://www.geeksforgeeks.org/problems/duplicate-zeros/1' },
          { name: 'Statistics From A Large Sample', leetcodeLink: 'https://leetcode.com/problems/statistics-from-a-large-sample/', gfgLink: 'https://www.geeksforgeeks.org/problems/statistics-from-a-large-sample/1' },
          { name: 'Partition Labels', leetcodeLink: 'https://leetcode.com/problems/partition-labels/', gfgLink: 'https://www.geeksforgeeks.org/problems/maximize-partitions-in-a-string/1' },
          { name: 'Magical String', leetcodeLink: 'https://leetcode.com/problems/magical-string/', gfgLink: 'https://www.geeksforgeeks.org/problems/magical-string/1' },
          { name: 'Friends Of Appropriate Ages', leetcodeLink: 'https://leetcode.com/problems/friends-of-appropriate-ages/', gfgLink: 'https://www.geeksforgeeks.org/problems/friends-of-appropriate-ages/1' },
          { name: 'Longest Mountain In Array', leetcodeLink: 'https://leetcode.com/problems/longest-mountain-in-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/longest-mountain-subarray/1' },
          { name: 'Shortest Subarray To Be Removed To Make Array Sorted', leetcodeLink: 'https://leetcode.com/problems/shortest-subarray-to-be-removed-to-make-array-sorted/', gfgLink: 'https://www.geeksforgeeks.org/problems/shortest-subarray-to-be-removed-to-make-array-sorted/1' },
          { name: 'Merge Sorted Array', leetcodeLink: 'https://leetcode.com/problems/merge-sorted-array/', gfgLink: 'https://www.geeksforgeeks.org/problems/merge-two-sorted-arrays-1587115620/1' },
          { name: 'Heaters', leetcodeLink: 'https://leetcode.com/problems/heaters/', gfgLink: 'https://www.geeksforgeeks.org/problems/heaters/1' },
          { name: 'Find The Distance Value Between Two Arrays', leetcodeLink: 'https://leetcode.com/problems/find-the-distance-value-between-two-arrays/', gfgLink: 'https://www.geeksforgeeks.org/problems/find-the-distance-value-between-two-arrays/1' },
          { name: 'Intersection Of Two Linked Lists', leetcodeLink: 'https://leetcode.com/problems/intersection-of-two-linked-lists/', gfgLink: 'https://www.geeksforgeeks.org/problems/intersection-of-two-linked-list/1' },
          { name: 'Intersection Of Two Arrays', leetcodeLink: 'https://leetcode.com/problems/intersection-of-two-arrays/', gfgLink: 'https://www.geeksforgeeks.org/problems/intersection-of-two-arrays-with-duplicate-elements/1' },
          { name: 'Intersection Of Two Arrays Ii', leetcodeLink: 'https://leetcode.com/problems/intersection-of-two-arrays-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/intersection-of-two-arrays-ii/1' },
          { name: 'Implement Strstr', leetcodeLink: 'https://leetcode.com/problems/implement-strstr/', gfgLink: 'https://www.geeksforgeeks.org/problems/implement-strstr/1' },
          { name: 'Longest Word In Dictionary Through Deleting', leetcodeLink: 'https://leetcode.com/problems/longest-word-in-dictionary-through-deleting/', gfgLink: 'https://www.geeksforgeeks.org/problems/longest-word-in-dictionary-through-deleting/1' },
          { name: 'Long Pressed Name', leetcodeLink: 'https://leetcode.com/problems/long-pressed-name/', gfgLink: 'https://www.geeksforgeeks.org/problems/long-pressed-name/1' },
          { name: 'Longest Uncommon Subsequence Ii', leetcodeLink: 'https://leetcode.com/problems/longest-uncommon-subsequence-ii/', gfgLink: 'https://www.geeksforgeeks.org/problems/longest-uncommon-subsequence-ii/1' },
          { name: 'Compare Version Numbers', leetcodeLink: 'https://leetcode.com/problems/compare-version-numbers/', gfgLink: 'https://www.geeksforgeeks.org/problems/compare-two-version-numbers/1' },
          { name: 'Camelcase Matching', leetcodeLink: 'https://leetcode.com/problems/camelcase-matching/', gfgLink: 'https://www.geeksforgeeks.org/problems/camelcase-matching/1' },
          { name: 'Expressive Words', leetcodeLink: 'https://leetcode.com/problems/expressive-words/', gfgLink: 'https://www.geeksforgeeks.org/problems/expressive-words/1' },
          { name: 'Find Median From Data Stream', leetcodeLink: 'https://leetcode.com/problems/find-median-from-data-stream/', gfgLink: 'https://www.geeksforgeeks.org/problems/find-median-in-a-stream-1587115620/1' },
          { name: 'Partition Array Into Two Arrays To Minimize Sum Difference', leetcodeLink: 'https://leetcode.com/problems/partition-array-into-two-arrays-to-minimize-sum-difference/', gfgLink: 'https://www.geeksforgeeks.org/problems/partition-array-into-two-arrays-to-minimize-sum-difference/1' },
          { name: 'Closest Subsequence Sum', leetcodeLink: 'https://leetcode.com/problems/closest-subsequence-sum/', gfgLink: 'https://www.geeksforgeeks.org/problems/closest-subsequence-sum/1' },
          { name: 'Ways To Split Array Into Three Subarrays', leetcodeLink: 'https://leetcode.com/problems/ways-to-split-array-into-three-subarrays/', gfgLink: 'https://www.geeksforgeeks.org/problems/ways-to-split-array-into-three-subarrays/1' },
          { name: '3sum Closest', leetcodeLink: 'https://leetcode.com/problems/3sum-closest/', gfgLink: 'https://www.geeksforgeeks.org/problems/3sum-closest/1' },
          { name: 'Valid Triangle Number', leetcodeLink: 'https://leetcode.com/problems/valid-triangle-number/', gfgLink: 'https://www.geeksforgeeks.org/problems/valid-triangle-number/1' },
          { name: 'Shortest Unsorted Continuous Subarray', leetcodeLink: 'https://leetcode.com/problems/shortest-unsorted-continuous-subarray/', gfgLink: 'https://www.geeksforgeeks.org/problems/shortest-unsorted-continuous-subarray/1' },
          { name: 'Most Profit Assigning Work', leetcodeLink: 'https://leetcode.com/problems/most-profit-assigning-work/', gfgLink: 'https://www.geeksforgeeks.org/problems/most-profit-assigning-work/1' },
          { name: 'Largest Merge Of Two Strings', leetcodeLink: 'https://leetcode.com/problems/largest-merge-of-two-strings/', gfgLink: 'https://www.geeksforgeeks.org/problems/largest-merge-of-two-strings/1' },
          { name: 'Swap Adjacent In Lr String', leetcodeLink: 'https://leetcode.com/problems/swap-adjacent-in-lr-string/', gfgLink: 'https://www.geeksforgeeks.org/problems/swap-adjacent-in-lr-string/1' },
          { name: 'Partition List', leetcodeLink: 'https://leetcode.com/problems/partition-list/', gfgLink: 'https://www.geeksforgeeks.org/problems/partition-list/1' },
          { name: 'Sort List', leetcodeLink: 'https://leetcode.com/problems/sort-list/', gfgLink: 'https://www.geeksforgeeks.org/problems/sort-list/1' }
        ]
      },
      {
