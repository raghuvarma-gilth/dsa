          ...
          <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '24px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                  ...
                  <button
                    ...
                    style={{ background: 'none', border: 'none', fontSize: '12px', color: '#8b5cf6', cursor: 'pointer', fontWeight: 600 }}
                  >
                    Forgot password?
                  </button>
                </div>
            ...
            <motion.button
              ...
              style={{
                ...
                opacity: loading ? 0.7 : 1, transition: 'opacity 0.2s', marginBottom: '16px'
              }}
            >
              {loading ? 'Processing...' : isReset ? 'Send Reset Link' : <>Sign In <ArrowRight size={16} /></>}
            </motion.button>
